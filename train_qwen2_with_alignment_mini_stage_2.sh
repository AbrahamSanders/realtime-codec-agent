python train.py \
    --log_level info \
    --model_name_or_path=Qwen1.5-1.8B-realtime-codec-agent-aligned-mini-stage-1 \
    ...
    --do_train \
    --bf16 \
    --output_dir=Qwen1.5-1.8B-realtime-codec-agent-aligned-mini-stage-2 \
    --do_eval \
